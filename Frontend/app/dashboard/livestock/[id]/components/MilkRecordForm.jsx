...
export default function MilkRecordForm({
    animalId,
    onCreated,
}) {
    ...
    const handleSubmit = async (e) => {
        ...
        const morning =
            formData.morning === ""
                ? undefined
                : Number(formData.morning);

        const evening =
            formData.evening === ""
                ? undefined
                : Number(formData.evening);
        ...
        if (
            ...
            setError(
                "Enter at least morning or evening milk."
            );
            return;
        }

        if (
            (morning !== undefined && morning < 0) ||
            (evening !== undefined && evening < 0)
        ) {
            setError("Milk quantity cannot be negative.");
            return;
        }
